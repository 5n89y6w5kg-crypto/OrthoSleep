...
function renderTopbar() {
  ...
  const showBack = ['client_detail', 'deal_detail', 'tasks', 'analytics', 'inbox', 'ai_knowledge', 'activity_logs', 'notifications', 'finance', 'conversation_analysis', 'templates', 'health'].includes(S.route);
