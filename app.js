...
async function loadOrdersContent() {
  ...
  let query = sb.from('orders')
    .select('*, clients(full_name,phone), deals(id,title,assigned_to,deal_items(qty,price,mattress_width,mattress_length,products(name))), profiles:manager_id(full_name)')
    .order('created_at', { ascending: false });
      ...
      ${filtered.map(o => {
        ...
        <div class="card">
          <div onclick="openOrderDetailSheet(${o.id})" style="cursor:pointer;">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;">
              ...
              <div style="text-align:right;">
                ...
                ${o.profiles?.full_name ? `<div style="font-size:11px;color:var(--text-faint);">${escapeHtml(o.profiles.full_name)}</div>` : ''}
              </div>
            </div>
          ...
          <div style="display:flex;gap:6px;margin-top:8px;flex-wrap:wrap;">
            ...
            ${isAdmin && managers?.length ? `<button class="btn-secondary" style="font-size:11px;padding:5px 8px;" onclick="openAssignManagerSheet(${o.id}, '${o.manager_id||''}')">👤 Менеджер</button>` : ''}
          </div>
        </div>
