...
function renderTopbar() {
  ...
  const showBack = ['client_detail', 'deal_detail', 'tasks', 'analytics', 'inbox', 'ai_knowledge'].includes(S.route);
...
async function renderAiKnowledge() {
  const [promotionsRes, businessInfoRes, productsRes] = await Promise.all([
