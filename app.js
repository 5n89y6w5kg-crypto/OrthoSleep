...
const TEMPLATE_CATS = {
  ...
  recommendation: '🛌 Подбор', advantages: '⭐ Плюсы', price_promo: '💵 Акция',
...
function buildTemplatesHtml() {
  ...
  return `
    <div class="page">
      ...
      <input type="text" placeholder="🔍 Поиск..." value="${escapeHtml(_templateSearch)}" oninput="_templateSearch=this.value;refreshTemplatesList()" style="margin-bottom:10px;">
      <div style="overflow-x:auto;white-space:nowrap;padding-bottom:8px;margin-bottom:12px;scrollbar-width:none;">
        ${Object.entries(TEMPLATE_CATS).map(([k,v]) => `
      ...
      <div id="tpl-list">
        ${filtered.length === 0 ? `<div class="empty-state"><div class="icon">📝</div><div class="title">Ничего не найдено</div></div>` :
